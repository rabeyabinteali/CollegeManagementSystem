...
public class DeleteStudentForm extends javax.swing.JFrame {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(55, 55, 55)
                        .addComponent(studid, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        try {
            ...
            pst= con.prepareStatement("delete from student where id="+sid);
            pst.executeUpdate();
            pst= con.prepareStatement("delete from coursestudent where id="+sid);
            pst.executeUpdate();
            pst= con.prepareStatement("delete from attendancelog where id="+sid);
            pst.executeUpdate();
            pst= con.prepareStatement("delete from dueaccounts where id="+sid);
            pst.executeUpdate();
            pst= con.prepareStatement("delete from marks where id="+sid);
            pst.executeUpdate();
            studid.setText("");
        } catch (Exception ex) {
